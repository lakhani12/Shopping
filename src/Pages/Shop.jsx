      ...
      <section>
        ...
        <div className="py-10 ">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            {/* filter */}
            <div className="1/4 bg-red-950 px-4-py-4 text-white">
              <select>
                <option className="bg-red-950 text-white w-full my-3  rounded-full">
                  Defualt
                </option>
                <option
                  className="bg-red-950 text-white w-full my-3  rounded-full"
                  value=""
                >
                  A to Z
                </option>
